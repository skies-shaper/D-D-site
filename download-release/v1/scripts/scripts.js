...
function markupHTMLConversion(text) {
    ...
    replacedText = replacedText.replace(/\[i (\S+) (.+?)\]/g, `<img src="https://skies-shaper.github.io/Worldbarrow/imgs/$1" alt="$2"></img>`)
    console.log("aaaaa")
...
function init() {
    ...
    if (SEARCH ==0) {
        ...
        document.getElementById("mapImg").src = "https://skies-shaper.github.io/Worldbarrow/imgs/" + LOCATION.data.header.img + ".svg"
